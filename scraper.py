...
while(url): 
    ...
    opinions = page.select("div.js_product-review")   
        for opinion in opinions:
            ...
            try:
                recommendation= page.select_one("span.user-post__author-recomendation >  em").get_text().strip() 
            except AttributeError: 
                recommendation = None 
            stars = page.select_one("span.user-post__score-count").get_text().strip()
...
with open ("opinions/634902892.json","w", encoding = "UTF-8") as jf: 
